...
class BottomNavBarPage extends StatefulWidget {
  ...
  @override
  State createState() => _BottomNavBarPageState();
}
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
            icon: Icon(GrootlyIcons.home2),
            label: 'Home',
          ),
          BottomNavigationBarItem(
            icon: Icon(GrootlyIcons.search2),
            label: 'Search',
          ),
          BottomNavigationBarItem(
            icon: Icon(GrootlyIcons.chefshat2),
            label: 'Recipes',
          ),
          BottomNavigationBarItem(
            icon: Icon(GrootlyIcons.sustainablehand),
            label: 'Tips',
          ),
        ],
